...
Modified behavior: add render.behind to render constraints behind bodies
...
(function() {
    ...
    Render.world = function(render, time) {
        ...
        // filter constraints that are behind
        let constraintsBehind = [];
        let constraintsInFront = [];
        for (let constraint of constraints) {
            if (constraint.render.behind === true) {
                constraintsBehind.push(constraint);
            }
            else {
                constraintsInFront.push(constraint);
            }
         }

        // render constraints that are behind bodies
        Render.constraints(constraintsBehind, context);
        ...
        // render remaining constraints
        Render.constraints(constraintsInFront, context);
